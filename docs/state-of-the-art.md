...
Соціальні мережі — це онлайн-платформи, що дозволяють людям спілкуватися, взаємодіяти, обмінюватися інформацією, контентом (фото, відео, текстом), а також будувати й підтримувати особисті та професійні зв'язки. Вони забезпечують засоби для створення профілів користувачів, публікації контенту, участі в групах за інтересами, коментування й лайків, а також обміну повідомленнями в режимі реального часу.

ЗМІ (засоби масової інформації) — це організації або платформи, що займаються збором, обробкою, публікацією та поширенням інформації для широкої аудиторії. Вони виконують важливу роль у суспільстві, інформуючи громадськість про актуальні події, новини, аналітику, культуру, розваги та багато іншого.

Моніторинг — це процес систематичного спостереження, збору, аналізу та оцінки інформації з метою відстеження змін, тенденцій або досягнення певних цілей. 
